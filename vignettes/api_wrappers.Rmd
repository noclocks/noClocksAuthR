...
`noClocksAuthR` now comes with functions that make it easy to interact with the noClocksAuthR API from
R.  See the individual wrapper function help files for details (e.g. `?noClocksAuthR::get_apps()`). 
