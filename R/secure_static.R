...
#' page using \code{noClocksAuthR}.  It is often used to add \code{noClocksAuthR} to \code{.Rmd} htmloutput
#' and flexdashboards.
#'
...
secure_static <- function(
  ...
  sign_out_button = shiny::actionLink(
    ...
    class = "noclocksauthr_sign_out_link"
  )) {
