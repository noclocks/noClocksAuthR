...
#'
#' Under the hood, \code{noClocksAuthR} uses Firebase JavaScript dependencies to handle
#' Social sign in & user authentication when \code{sign_in_providers} besides `"email"`
#' are included in \code{noclocksauthr_config()}. This function loads the required Firebase JavaScript dependencies
