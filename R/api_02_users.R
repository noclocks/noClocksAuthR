...
#' will be returned.
#'
#' @return an object of class \code{noclocksauthr_api_res}.  The `content` of the object is a
...
get_users <- function(
  ...
  resp <- httr::GET(
    url = paste0(noclocksauthr$api_url, "/users"),
    ua,
    httr::authenticate(
      user = api_key,
      password = ""
...
#' noClocksAuthR API - Delete a User
#'
...
#' noClocksAuthR API - Update a user
#'
