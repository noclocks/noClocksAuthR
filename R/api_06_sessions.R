#' noClocksAuthR API - Get Session(s)
#'
...
#'
#' @return either \code{NULL} or object of class \code{noclocksauthr_api_res}.  The "content" of the object is a
...
#' noClocksAuthR API - Add a session
#'
#' @param app_uid the app uid.
...
#' noClocksAuthR API - Update a session
#'
