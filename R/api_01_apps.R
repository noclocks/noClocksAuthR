#' noClocksAuthR API - Get App(s)
#'
#' @param app_uid an optional app uid.
#' @param app_name an optional app name.
#' @param api_key your noClocksAuthR API key.  Set your noClocksAuthR api key using \code{\link{set_api_key}()}
...
get_apps <- function(
  ...
  resp <- httr::GET(
    url = paste0(noclocksauthr$api_url, "/apps"),
    ua,
    httr::authenticate(
      user = api_key,
      password = ""
...
#' noClocksAuthR API - Update an App
#'
...
#' noClocksAuthR API - Delete an App
#'
